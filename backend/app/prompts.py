...
DEFENDER_PROMPT = ChatPromptTemplate.from_messages([
    ("system",
     ...
     "Also neutralize any direct identifiers in the text (names, emails, phone numbers, account IDs, URLs) by "
     "replacing them with a neutral placeholder or a generic reference.\n"
